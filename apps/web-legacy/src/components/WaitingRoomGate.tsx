...
function checkRequestExpired(
	...
	const planStatus = isPlanAwarenessState(planStatusRaw)
		? planStatusRaw
		: undefined;
		...
		<div className="flex items-center justify-center min-h-[60vh] p-4">
			<div className="bg-surface border border-separator rounded-lg p-8 max-w-md w-full text-center">
				...
				<p className="text-muted-foreground mb-4">
					Your access request for <span className="font-medium">{title}</span>{" "}
					has expired.
				</p>

				<p className="text-sm text-muted-foreground mb-6">
					Access requests expire after 24 hours. Click below to request access
					again.
				</p>
		...
		<div className="flex items-center justify-center min-h-[60vh] p-4">
			<div className="bg-surface border border-separator rounded-lg p-8 max-w-md w-full text-center">
				...
				<p className="text-sm text-muted-foreground">
					The task owner will be notified of your request. You can close this
					tab to cancel.
				</p>
			</div>
		</div>
	...
	return (
		<div className="flex items-center justify-center min-h-[60vh] p-4">
			<div className="bg-surface border border-separator rounded-lg p-8 max-w-md w-full text-center">
				...
				<p className="text-muted-foreground mb-4">
					Your request to access <span className="font-medium">{title}</span>{" "}
					was denied.
				</p>
	...
	return (
		<div className="flex items-center justify-center min-h-[60vh] p-4">
			<div className="bg-surface border border-separator rounded-lg p-8 max-w-md w-full text-center">
				...
				<p className="text-muted-foreground mb-4">
					You need to sign in to request access to{" "}
					<span className="font-medium">{title}</span>.
				</p>

				<p className="text-sm text-muted-foreground mb-6">
					After signing in with GitHub, the task owner will be notified of your
					access request.
				</p>
