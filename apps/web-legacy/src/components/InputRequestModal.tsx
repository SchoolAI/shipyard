...
function isSubmitDisabled(
	...
	if (!isOtherSelected && (Array.isArray(value) ? value.length === 0 : !value))
		return true;
	return false;
}
...
export function InputRequestModal({
	...
	const modalConfig = useMemo(
		() => getModalConfig(request?.message || ""),
		[request?.message],
	);
		...
		return (
			...
			>
				<Modal.Container placement="center" size="md">
					<Modal.Dialog
						className={modalConfig.isLarge ? "sm:max-w-[650px]" : undefined}
					>
						<Modal.CloseTrigger />
						...
						<Card
							className={
								request.isBlocker
									? "border-2 border-danger ring-2 ring-danger/20"
									: ""
							}
						>
							<Card.Header>
