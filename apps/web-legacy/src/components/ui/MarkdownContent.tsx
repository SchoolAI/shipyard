...
const markdownComponents: Components = {
	...
	code: (props: {
		...
		if (isInline) {
			return (
				<code
					className="bg-surface px-1.5 py-0.5 rounded text-[0.9em] font-mono"
					{...rest}
				>
					{children}
				</code>
	...
	h1: ({ children }: { children?: React.ReactNode }) => (
		<h1 className="font-semibold text-foreground mb-2 mt-3 first:mt-0">
			{children}
		</h1>
	),
	h2: ({ children }: { children?: React.ReactNode }) => (
		<h2 className="font-semibold text-foreground mb-2 mt-3 first:mt-0">
			{children}
		</h2>
	),
	h3: ({ children }: { children?: React.ReactNode }) => (
		<h3 className="font-medium text-foreground mb-1.5 mt-2 first:mt-0">
			{children}
		</h3>
	),
	h4: ({ children }: { children?: React.ReactNode }) => (
		<h4 className="font-medium text-foreground mb-1 mt-2 first:mt-0">
			{children}
		</h4>
	),
	h5: ({ children }: { children?: React.ReactNode }) => (
		<h5 className="font-medium text-foreground mb-1 mt-1 first:mt-0">
			{children}
		</h5>
	),
	h6: ({ children }: { children?: React.ReactNode }) => (
		<h6 className="font-medium text-muted-foreground mb-1 mt-1 first:mt-0">
			{children}
		</h6>
	),
