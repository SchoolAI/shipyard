...
export function ReviewActions({
	...
	const validateReviewAction = (
		...
		const currentStatus =
			typeof rawStatus === "string" && isValidPlanStatus(rawStatus)
				? rawStatus
				: undefined;
	...
	const updateReviewStatus = (
		...
		const newStatus =
			action === "approve" ? "in_progress" : "changes_requested";
		...
		try {
			...
			const errorMessage =
				error instanceof Error
					? error.message
					: "Unknown error during status update";
