 ...
 */
export function AddCommentToolbarButton({ onAddComment }: AddCommentToolbarButtonProps) {
  ...
  if (!Components) {
    throw new Error('AddCommentToolbarButton must be used within BlockNote context');
  }
  ...
  return (
    <Components.FormattingToolbar.Button mainTooltip="Add Comment" onClick={handleClick}>
