...
var schema = external_exports.object({
  ...
  GITHUB_TOKEN: external_exports.string().optional().transform((val) => val || getTokenFromGhCli() || null),
  SHIPYARD_ARTIFACTS: external_exports.string().optional().transform((val) => {
    if (!val) return true;
