...
export function PlanPage() {
	 ...
	 */
	const { redemptionState, clearInviteToken } = useInviteToken(
		planId,
		rtcProvider,
		githubIdentity,
	);
					...
					<div className="flex flex-col items-center gap-4 text-center max-w-md">
						...
						<div>
							...
							<p className="text-sm text-muted-foreground mb-4">
								Connected to {syncState.peerCount} peer
								{syncState.peerCount > 1 ? "s" : ""} but couldn&apos;t load task
								data. The peer may not have the plan you&apos;re looking for.
							</p>
						</div>
					...
					<div className="flex items-center justify-center min-h-[60vh] p-4">
						<div className="bg-surface border border-separator rounded-lg p-8 max-w-md w-full text-center">
							...
							<p className="text-sm text-muted-foreground mb-6">
								If you own this task or have been granted access, you'll be able
								to view it after signing in.
							</p>
					...
					return (
						<div className="flex items-center justify-center min-h-[60vh] p-4">
							<div className="bg-surface border border-separator rounded-lg p-8 max-w-md w-full text-center">
								...
								<p className="text-muted-foreground mb-4">
									Could not connect to the task owner&apos;s session to redeem
									your invite.
								</p>
								<p className="text-sm text-muted-foreground mb-6">
									The task owner may be offline. Try again later or request
									manual access.
								</p>
								<div className="flex flex-col gap-2">
									<Button
