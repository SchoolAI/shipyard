 ...
 * Returns "just now" for recent activity, or "Xm ago" / "Xh ago" for older.
 */
							...
							return (
								<div key={`browser-${idx}`} className="flex flex-col gap-1">
									<div className="flex items-center gap-2">
										...
										<span className="font-medium">
											{browser.name && browser.name !== `Peer ${idx}`
												? browser.name
												: "Anonymous"}
										</span>
										{lastActiveText && (
 ...
 */
function CopySnapshotUrlButton({
	ydoc,
	metadata,
	editor,
}: CopySnapshotUrlButtonProps) {
								...
								<div className="grid grid-cols-2 gap-2 text-sm">
									<div>
										...
										<span className="text-foreground">
											{importData.meta.sourcePlatform}
										</span>
									</div>
									<div>
										<span className="text-muted-foreground">Messages:</span>{" "}
										<span className="text-foreground">
											{importData.meta.messageCount}
										</span>
									</div>
									<div>
