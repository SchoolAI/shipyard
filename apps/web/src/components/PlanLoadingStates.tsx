      ...
      <div className="flex flex-col items-center gap-4 text-center max-w-md">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Connected to {peerCount} peer{peerCount > 1 ? 's' : ''} but couldn&apos;t load task
    ...
    <div className="flex items-center justify-center min-h-[60vh] p-4">
      <div className="bg-surface border border-separator rounded-lg p-8 max-w-md w-full text-center">
        ...
        <p className="text-sm text-muted-foreground mb-6">
          If you own this task or have been granted access, you'll be able to view it after signing
          in.
        </p>
...
export function PlanNotFoundState({ planId }: PlanNotFoundStateProps) {
  return (
    <div className="p-8 text-center">
      ...
      <p className="text-muted-foreground">The task &quot;{planId}&quot; does not exist.</p>
