...
describe('MultilineInput', () => {
  it('should render with message as label', () => {
    ...
    render(<MultilineInput request={request} value="" setValue={vi.fn()} isSubmitting={false} />);
  ...
  it('should call setValue when user types', async () => {
    ...
    render(<MultilineInput request={request} value="" setValue={setValue} isSubmitting={false} />);
  ...
  it('should show defaultValue as placeholder', () => {
    const request = createMultilineRequest({ defaultValue: 'Enter details...' });
    render(<MultilineInput request={request} value="" setValue={vi.fn()} isSubmitting={false} />);
  ...
  it('should be disabled when isSubmitting is true', () => {
    const request = createMultilineRequest();
    render(<MultilineInput request={request} value="" setValue={vi.fn()} isSubmitting={true} />);
