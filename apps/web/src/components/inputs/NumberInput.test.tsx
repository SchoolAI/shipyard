...
describe('NumberInput', () => {
  it('should render with message as label', () => {
    ...
    render(<NumberInput request={request} value="" setValue={vi.fn()} isSubmitting={false} />);
  ...
  it('should call setValue when user types', async () => {
    ...
    render(<NumberInput request={request} value="" setValue={setValue} isSubmitting={false} />);
  ...
  it('should display current value in the input', () => {
    const request = createNumberRequest();
    render(<NumberInput request={request} value="100" setValue={vi.fn()} isSubmitting={false} />);
  ...
  it('should show error when value is above maximum', () => {
    ...
    render(<NumberInput request={request} value="150" setValue={vi.fn()} isSubmitting={false} />);
  ...
  it('should show error for invalid number input', () => {
    const request = createNumberRequest();
    render(
      <NumberInput request={request} value="not-a-number" setValue={vi.fn()} isSubmitting={false} />
    );
  ...
  it('should not show error for valid number within bounds', () => {
    const request = createNumberRequest({ min: 0, max: 100 });
    render(<NumberInput request={request} value="50" setValue={vi.fn()} isSubmitting={false} />);
  ...
  it('should be disabled when isSubmitting is true', () => {
    const request = createNumberRequest();
    render(<NumberInput request={request} value="" setValue={vi.fn()} isSubmitting={true} />);
