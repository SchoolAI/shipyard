...
import type { BaseInputProps, NumberInputRequest } from './types';
...
export function NumberInput({
  ...
  const isBelowMin =
    hasValue && !Number.isNaN(parsedNum) && request.min != null && parsedNum < request.min;
  const isAboveMax =
    hasValue && !Number.isNaN(parsedNum) && request.max != null && parsedNum > request.max;
