...
export interface UseHeaderActionsReturn {
  ...
  handleMobileFileSelect: (event: React.ChangeEvent<HTMLInputElement>) => Promise<void>;
...
export function useHeaderActions(
  ...
  const handleMobileFileSelect = async (event: React.ChangeEvent<HTMLInputElement>) => {
