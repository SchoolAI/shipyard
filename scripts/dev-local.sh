#!/usr/bin/env bash
# Run peer-plan locally in production-like mode
...
PORT=${PORT:-5173}
export PEER_PLAN_WEB_URL="http://localhost:$PORT"
...
echo "🔨 Building hook..."
pnpm build --filter=@peer-plan/hook
...
if [ "$PORT" != "5173" ]; then
  ...
  echo "    \"env\": { \"PEER_PLAN_WEB_URL\": \"http://localhost:$PORT\" }"
  echo ""
fi
echo "Next steps:"
...
echo "PEER_PLAN_WEB_URL=$PEER_PLAN_WEB_URL"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
