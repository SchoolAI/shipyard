...
export type HasConnectionsResponse = z.infer<
	typeof HasConnectionsResponseSchema
>;
...
export type SubscriptionClientIdInput = z.infer<
	typeof SubscriptionClientIdSchema
>;
...
export type SetSessionTokenRequest = z.infer<
	typeof SetSessionTokenRequestSchema
>;
...
export type GetDeliverableContextRequest = z.infer<
	typeof GetDeliverableContextRequestSchema
>;
...
export type GetDeliverableContextResponse = z.infer<
	typeof GetDeliverableContextResponseSchema
>;
...
export type SetSessionTokenResponse = z.infer<
	typeof SetSessionTokenResponseSchema
>;
...
export const ImportConversationResponseSchema = z.discriminatedUnion(
	"success",
	[
		z.object({
...
export type ImportConversationResponse = z.infer<
	typeof ImportConversationResponseSchema
>;
