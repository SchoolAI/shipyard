 ...
 */
export const PlanViewTabValues = [
	"plan",
	"activity",
	"deliverables",
	"changes",
...
export function getPlatformDisplayName(platform: string): string {
	...
	return validPlatform
		? PLATFORM_DISPLAY_NAMES[validPlatform]
		: "Unknown Agent";
}
...
export type ClaudeCodeOriginMetadata = z.infer<
	typeof ClaudeCodeOriginMetadataSchema
>;
...
export function isInboxWorthy(
	...
	const resolvedInboxFor =
		event.inboxFor === "owner" && ownerId ? ownerId : event.inboxFor;
...
export const LinkedPRStatusValues = [
	"draft",
	"open",
	"merged",
	"closed",
