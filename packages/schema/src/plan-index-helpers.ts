 ...
 */
export function getPlanIndexEntry(
	ydoc: Y.Doc,
	planId: string,
): PlanIndexEntry | null {
	const plansMap = ydoc.getMap<PlanIndexEntry>(YDOC_KEYS.PLANS);
 ...
 */
export function getViewedByFromIndex(
	ydoc: Y.Doc,
	planId: string,
 ...
 */
export function updatePlanIndexViewedBy(
	ydoc: Y.Doc,
	planId: string,
	username: string,
): void {
 ...
 */
export function clearPlanIndexViewedBy(
	ydoc: Y.Doc,
	planId: string,
	username: string,
): void {
