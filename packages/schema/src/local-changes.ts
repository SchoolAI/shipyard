...
export type LocalChangesUnavailableReason = z.infer<
	typeof LocalChangesUnavailableReasonSchema
>;
...
export type LocalChangesUnavailable = z.infer<
	typeof LocalChangesUnavailableSchema
>;
